                        ...
                        <div className="flex-1 text-center md:text-left space-y-3">
                            ...
                            <div className="flex justify-center md:justify-start gap-4 pt-2">
                                <div className="bg-white/5 px-4 py-2 rounded-lg border border-white/5">
                                    <span className="block text-[8px] text-muted-foreground uppercase font-bold tracking-widest mb-1">Status de Combatente</span>
                                    <span className="text-sm font-serif uppercase tracking-widest text-primary">{player.rank}</span>
                                </div>
                            </div>
                        </div>
                    </div>
